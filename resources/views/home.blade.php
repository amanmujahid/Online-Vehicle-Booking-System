		...
		<div class="col-lg-4 p-2 "><!-- Individual card -->
				...
				<div class="card shadow pt-2" style="max-width: 350px margin:auto; ;">
					...
					<div class="card-body">
						...
						<h6 class="card-title mb-2">Our collection of buses provide the ultimate comfort for every traveller</h6>
			...
			<div class="col-lg-4 p-2 "><!-- Individual card -->
				...
				<div class="card shadow pt-2" style="max-width: 350px margin:auto; ;">
					...
					<div class="card-body">
						...
						<h6 class="card-title mb-2">Our collection of trains provide a vast sense of luxury</h6>
			...
			<div class="col-lg-4 p-2 "><!-- Individual card -->
				...
				<div class="card shadow pt-2" style="max-width: 350px margin:auto; ;">
					...
					<div class="card-body">
						...
						<h6 class="card-title mb-2">Get the ultimate flying experience you've always dreamt of</h6>
